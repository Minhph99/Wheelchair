...
echo_and_run cd "/home/ubuntu/catkin_ws/src/ros-slam-nav/robot_ml/robot_dqn"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/catkin_ws/src/ros-slam-nav/robot_ml/robot_dqn/setup.py" \
     \
    build --build-base "/home/ubuntu/catkin_ws/build/ros-slam-nav/robot_ml/robot_dqn" \
    install \
    --root="${DESTDIR-/}" \
