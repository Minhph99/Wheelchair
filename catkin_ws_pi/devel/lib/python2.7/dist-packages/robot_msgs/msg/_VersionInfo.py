...
"""autogenerated by genpy from robot_msgs/VersionInfo.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.hardware = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.software = str[start:end].decode('utf-8', 'rosmsg')
      else:
