...
(cl:defmethod cl:initialize-instance :after ((m <Sound>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sound)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<Sound> is deprecated: use robot_msgs-msg:Sound instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Sound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:value-val is deprecated.  Use robot_msgs-msg:value instead.")
  (value m))
