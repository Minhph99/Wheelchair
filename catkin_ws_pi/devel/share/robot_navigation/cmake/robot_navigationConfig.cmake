...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ros-slam-nav/robot/robot_navigation)
  set(robot_navigation_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(robot_navigation_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ros-slam-nav/robot/robot_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND robot_navigation_EXPORTED_TARGETS ${${robot_navigation_dep}_EXPORTED_TARGETS})
endforeach()
